    ...
    if file_name:
        ...
        if raw_data.ndim > 1:
            ...
            with st.sidebar:
                ...
                spec_width = st.slider("Spectrogram Width", 4, 20, 8)
                spec_height = st.slider("Spectrogram Height", 2, 10, 3)
                signal_width = st.slider("Signal Plot Width", 4, 20, 10)
                signal_height = st.slider("Signal Plot Height", 1, 5, 1.5)
